...
static void read_blif(char *blif_file, boolean sweep_hanging_nets_and_inputs,
	...
	// index "i" is the index of the type and it will be 1 and rest will be 0

	/*for (int i = 0; i < num_logical_blocks; i++) {
		std::vector<int> types(num_types, 0);
		types[logical_block[i].model->index] = 1;
		logical_block_types.push_back(types);
	}*/

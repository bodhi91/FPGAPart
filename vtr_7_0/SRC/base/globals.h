...
// for TritonPart -- the god of netlist partitioenrs
extern std::vector<float> logical_net_criticalities;
extern std::vector<float> logical_block_criticalities;
extern std::vector<std::vector<int> > logical_block_types;
...
/**********************************************************
 * Strictly for TritonPart 2.0 only
*/

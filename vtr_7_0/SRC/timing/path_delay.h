...
bool lambda_sort_path(const std::pair<float, int> &path_a, const std::pair<float, int> &path_b);
...
void print_top_n_critical_patjs(int n, const char *fname);

void print_mapped_top_n_critical_paths(int n, const char *fname);
